...
function Result(props) {
    ...
    return (
        <ResultContainer id='result'>
            {consoleLogQtt===0&&<h4><u>{consoleLogQtt}</u> console.logs found</h4>}
            {consoleLogQtt===1&&<h4><u>{consoleLogQtt}</u> console.log found at:</h4>}
            {consoleLogQtt>1&&<h4><u>{consoleLogQtt}</u> console.logs found at:</h4>}
            <ul>
